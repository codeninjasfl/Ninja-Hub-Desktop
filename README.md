...
### 🛠️ Windows Debug Log Console
- **Debug Launcher**: Includes `DEBUG-LAUNCHER-WINDOWS.bat` to launch with `--enable-logging --v=1`, capturing live stdout/stderr and keeping all tracebacks permanently open on screen after app exit for easy debugging.
